...
import '../modules/categories/data/categories_repository.dart' as _i12;
import '../modules/categories/data/categories_repository_impl.dart' as _i13;
import '../modules/categories/service/categories_service.dart' as _i14;
import '../modules/categories/service/categories_service_impl.dart' as _i15;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i12.CategoriesRepository>(
        () => _i13.CategoriesRepositoryImpl(
              connection: gh<_i3.DatabaseConnection>(),
              log: gh<_i8.Logger>(),
            ));
    gh.lazySingleton<_i14.CategoriesService>(() => _i15.CategoriesServiceImpl(
    ...
    gh.factory<_i17.CategoriesController>(() => _i17.CategoriesController(
          categoriesService: gh<_i14.CategoriesService>(),
          log: gh<_i8.Logger>(),
        ));
    return this;
  }
